package com.smartjob.bci.common;
...
public class Constants {
    ...
    public static final String CORREO_EXISTS = "Correo ya está registrado";
    public static final String EMAIL_RGX = "^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,6}$";
